...
UPDATE Authors2
SET au_fname = 'Buford'
WHERE au_fname = '' OR au_fname IS NULL;
SELECT * FROM Authors2;
...
#Q5
UPDATE Authors2
SET email = CONCAT(LEFT(au_fname,1), au_lname, '@hotmail.com');
SELECT * FROM Authors2;

#Q6
UPDATE Authors2
SET phone = Concat('475', right(phone,9))
WHERE city = 'San Francisco' AND state = 'CA' AND phone LIKE '415%';
SELECT * FROM Authors2;
