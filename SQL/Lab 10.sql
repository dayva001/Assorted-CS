...
Insert Into Artists Values(2,'Louis Holiday','Clinton','IL','USA' ,NULL,'2003-06-
03','Directmail');
Insert Into Artists Values(3,'Word','Anderson','IN','USA',NULL,'2003-06-
08','Email');
Insert Into Artists
Values(5,'Sonata','Alexandria','VA','USA','www.classical.com/sonata','2003-06-
08','Ad');
Insert Into Artists Values(10,'The Bullets','Alverez','TX','USA',NULL,'2003-08-
10','Email');
Insert Into Artists Values(14,'Jose MacArthur','Santa
Rosa','CA','USA','www.josemacarthur.com','2003-08-17','Ad');
Insert Into Artists Values(15,'Confused','Tybee Island','GA','USA',Null,'2003-09-
14','Directmail');
Insert Into Artists Values(17,'The Kicks','New Rochelle','NY','USA',NULL,'2003-12-
03','Ad');
Insert Into Artists
...
Insert Into Artists Values(11,'Highlander','Columbus','OH','USA',NULL,'2002-08-
10','Email');
CREATE TABLE Genre (
Genre varchar (15)
);
...
1','Anderson','IN','46019','USA','7651552983','7651628837','ral@mightyhostl.com','M
','1968-01-18',2);
Insert Into Members Values(31,'Jose','MacArthur','51444 Vine','Santa
Rosa','CA','99999','USA','6331289393',Null,'jmac@dowop.com','M','1978-06-24',1);
Insert Into Members Values(13,'Mary','Chrisman','1772 East
117th','Fishers','IN','46123','USA','3171820387',Null,'mjc17@daviscorp.com','F','19
73-03-01',1);
Insert Into Members Values(15,'Warren','Boyer','167 Alamo
Dr','Alverez','TX','75601','USA','8221722883',Null,'wbman@uptime.net','M','1969-04-
19',2);
Insert Into Members Values(32,'Doug','Finney','2020
Dubois','Savannah','GA','30003','USA','9821222929',Null,'fennyd@bitspeed.com','M','
1963-08-04',3);
...
Bonaventure','Savannah','GA','30005','USA','8221928273',Null,Null,'F','1964-03-
15',2);
Insert Into Members Values(34,'William','Morrow','PO Box 1882','New
Rochelle','NY','10014','USA','9981722928',Null,'wmorrow@wmorrow.com','M','1965-03-
17',2);
...
38th','Alverez','TX','75601','USA','8321729283','8321723833','kosmo@ispl.com','M','
1983-09-02',2);
Insert Into Members Values(3,'Bryce','Sanders','PO Box
1292','Peterson','NC','27104','USA','6441824283',Null,'bs@cookery.com','M','1966-
06-11',2);
...
Lane','London','ONT','M6Y 2Y7 ','Canada','6231842933',Null,Null,'M','1957-10-
19',3);
Insert Into Members Values(7,'Marcellin','Lambert','142 Sample
Rd','Alexandria','VA','20102','USA','8331929302',Null,'mlambert@corkscrew.com','M',
'1959-11-14',3);
...
Midway','Lynchberg','VA','21223','USA','2211229384','2211223939',Null,'M','1962-01-
16',1);
Insert Into Members Values(26,'Tony','Wong','115 Maple St','McKensie','ONT','M8H
3T1','Canada','3311692832','3311692822','twong@tamilla.org','M','1955-11-01',2);
Insert Into Members
Values(18,'Bonnie','Taft','RR4','Alamaba','VT','05303','USA','3721223292',Null,'taf
fygirl@signon.com','F','1960-09-21',1);
Insert Into Members Values(20,'Louis','Holiday','15 Davis
Ct','Clinton','IL','63882','USA','1451223838',Null,Null,'M','1969-07-27',2);
Insert Into Members
Values(22,'Bobby','Crum','RR2','Pine','VT','05412','USA','1831828211',Null,Null,'M'
,'1965-06-10',3);
...
Rd','Columbus','OH','48318','USA','2771152882','2771128833','goody@irvingnet.com','
M','1980-10-27',2);
...
BEGIN
	INSERT INTO Members_audit(memberID, firstname, lastname, changedat)
    VALUES (old.memberID, old.firstname, old.lastname, NOW());
END; $$
DELIMITER ;
#TEST
SELECT *
...
#TEST
Insert Into Titles Values(2,3,'TEST',1,'TEST','jazz');
Insert Into Titles Values(2,3,'TEST',1,'TEST','jazz');
SELECT *
FROM Titles_Total;
...
DROP TRIGGER IF EXISTS after_artists_insert;
...
SET
    ...
    Message = CASE WHEN NEW.WebAddress is NULL
				THEN CONCAT_WS(' ', 'Welcome', new.ArtistName,'Please do not forget to provide your web address!')
                ELSE
                CONCAT_WS(' ', 'Welcome', new.ArtistName)
END;
$$
DELIMITER ;

#TESTS
Insert Into Artists Values(30,'TEST','California','CA','USA',NULL,'2003-02-05','Ad');
Insert Into Artists Values(31,'TEST2','California','CA','USA','bobby.com','2003-02-05','Ad');
SELECT * FROM Artist_Welcome;
